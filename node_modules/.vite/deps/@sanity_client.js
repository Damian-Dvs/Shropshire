import {
  isRecord,
  stegaClean
} from "./chunk-M67FX7UO.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
  __publicField
} from "./chunk-5TM7ADKI.js";
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-KX46BETD.js").then(function(n4) {
...
var eventSourcePolyfill = defer(() => import("./browser-A6X67FZN.js")).pipe(
...
var ObservableDatasetsClient = class {
   ...
   */
  list() {
    return _request(__privateGet(this, _client10), __privateGet(this, _httpRequest5), {
      uri: "/datasets",
      tag: null
    });
  }
...
var DatasetsClient = class {
  ...
  list() {
    return resourceGuard("dataset", __privateGet(this, _client11).config()), lastValueFrom(
      _request(__privateGet(this, _client11), __privateGet(this, _httpRequest6), { uri: "/datasets", tag: null })
    );
  }
};
...
var ObservableProjectsClient = class {
  ...
  list(options) {
    resourceGuard("projects", __privateGet(this, _client12).config());
    const uri = (options == null ? void 0 : options.includeMembers) === false ? "/projects?includeMembers=false" : "/projects";
    return _request(__privateGet(this, _client12), __privateGet(this, _httpRequest7), { uri });
  }
  /**
   ...
   */
  getById(projectId2) {
    return resourceGuard("projects", __privateGet(this, _client12).config()), _request(__privateGet(this, _client12), __privateGet(this, _httpRequest7), { uri: `/projects/${projectId2}` });
  }
};
...
var ProjectsClient = class {
  ...
  list(options) {
    resourceGuard("projects", __privateGet(this, _client13).config());
    const uri = (options == null ? void 0 : options.includeMembers) === false ? "/projects?includeMembers=false" : "/projects";
    return lastValueFrom(_request(__privateGet(this, _client13), __privateGet(this, _httpRequest8), { uri }));
  }
  /**
   * Fetch a project by project ID
   *
   ...
   */
  getById(projectId2) {
    return resourceGuard("projects", __privateGet(this, _client13).config()), lastValueFrom(
      _request(__privateGet(this, _client13), __privateGet(this, _httpRequest8), { uri: `/projects/${projectId2}` })
    );
  }
};
...
var ObservableReleasesClient = class {
  ...
  create(releaseOrOptions, maybeOptions) {
    ...
    return _action(__privateGet(this, _client14), __privateGet(this, _httpRequest9), action, options).pipe(
      map((actionResult) => ({
        ...actionResult,
        releaseId,
        metadata
  ...
  edit({ releaseId, patch }, options) {
    ...
    return _action(__privateGet(this, _client14), __privateGet(this, _httpRequest9), editAction, options);
  }
  /**
   * @public
   *
  ...
  publish({ releaseId }, options) {
    ...
    return _action(__privateGet(this, _client14), __privateGet(this, _httpRequest9), publishAction, options);
  }
  /**
   * @public
   *
  ...
  archive({ releaseId }, options) {
    ...
    return _action(__privateGet(this, _client14), __privateGet(this, _httpRequest9), archiveAction, options);
  }
  /**
   * @public
   *
  ...
  unarchive({ releaseId }, options) {
    ...
    return _action(__privateGet(this, _client14), __privateGet(this, _httpRequest9), unarchiveAction, options);
  }
  /**
   * @public
   *
  ...
  schedule({ releaseId, publishAt }, options) {
    ...
    return _action(__privateGet(this, _client14), __privateGet(this, _httpRequest9), scheduleAction, options);
  }
  /**
   * @public
   *
  ...
  unschedule({ releaseId }, options) {
    ...
    return _action(__privateGet(this, _client14), __privateGet(this, _httpRequest9), unscheduleAction, options);
  }
  /**
   * @public
   *
  ...
  delete({ releaseId }, options) {
    ...
    return _action(__privateGet(this, _client14), __privateGet(this, _httpRequest9), deleteAction, options);
  }
  /**
   * @public
   *
  ...
  fetchDocuments({ releaseId }, options) {
    return _getReleaseDocuments(__privateGet(this, _client14), __privateGet(this, _httpRequest9), releaseId, options);
  }
};
...
var ReleasesClient = class {
  ...
  async create(releaseOrOptions, maybeOptions) {
    ...
    return { ...await lastValueFrom(
      _action(__privateGet(this, _client15), __privateGet(this, _httpRequest10), action, options)
    ), releaseId, metadata };
  }
  /**
   * @public
  ...
  edit({ releaseId, patch }, options) {
    ...
    return lastValueFrom(_action(__privateGet(this, _client15), __privateGet(this, _httpRequest10), editAction, options));
  }
  /**
   * @public
   *
  ...
  publish({ releaseId }, options) {
    ...
    return lastValueFrom(_action(__privateGet(this, _client15), __privateGet(this, _httpRequest10), publishAction, options));
  }
  /**
   * @public
   *
  ...
  archive({ releaseId }, options) {
    ...
    return lastValueFrom(_action(__privateGet(this, _client15), __privateGet(this, _httpRequest10), archiveAction, options));
  }
  /**
   * @public
   *
  ...
  unarchive({ releaseId }, options) {
    ...
    return lastValueFrom(_action(__privateGet(this, _client15), __privateGet(this, _httpRequest10), unarchiveAction, options));
  }
  /**
   * @public
   *
  ...
  schedule({ releaseId, publishAt }, options) {
    ...
    return lastValueFrom(_action(__privateGet(this, _client15), __privateGet(this, _httpRequest10), scheduleAction, options));
  }
  /**
   * @public
   *
  ...
  unschedule({ releaseId }, options) {
    ...
    return lastValueFrom(_action(__privateGet(this, _client15), __privateGet(this, _httpRequest10), unscheduleAction, options));
  }
  /**
   * @public
   *
  ...
  delete({ releaseId }, options) {
    ...
    return lastValueFrom(_action(__privateGet(this, _client15), __privateGet(this, _httpRequest10), deleteAction, options));
  }
  /**
   * @public
   *
   ...
   */
  fetchDocuments({ releaseId }, options) {
    return lastValueFrom(_getReleaseDocuments(__privateGet(this, _client15), __privateGet(this, _httpRequest10), releaseId, options));
  }
};
...
var ObservableUsersClient = class {
  constructor(client, httpRequest) {
    ...
    __privateAdd(this, _httpRequest11, void 0);
...
var UsersClient = class {
  constructor(client, httpRequest) {
    __privateAdd(this, _client17, void 0);
    __privateAdd(this, _httpRequest12, void 0);
  ...
  getById(id) {
    return lastValueFrom(
      _request(__privateGet(this, _client17), __privateGet(this, _httpRequest12), {
        uri: `/users/${id}`
      })
    );
  }
...
var _clientConfig, _httpRequest13;
var _ObservableSanityClient = class _ObservableSanityClient {
  constructor(httpRequest, config2 = defaultConfig) {
    ...
    __privateAdd(this, _httpRequest13, void 0);
    /**
     * Instance properties
     */
    __publicField(this, "listen", _listen);
    this.config(config2), __privateSet(this, _httpRequest13, httpRequest), this.assets = new ObservableAssetsClient(this, __privateGet(this, _httpRequest13)), this.datasets = new ObservableDatasetsClient(this, __privateGet(this, _httpRequest13)), this.live = new LiveClient(this), this.projects = new ObservableProjectsClient(this, __privateGet(this, _httpRequest13)), this.users = new ObservableUsersClient(this, __privateGet(this, _httpRequest13)), this.agent = {
      action: new ObservableAgentsActionClient(this, __privateGet(this, _httpRequest13))
    }, this.releases = new ObservableReleasesClient(this, __privateGet(this, _httpRequest13));
  }
  /**
   * Clone the client - returns a new instance
   */
  clone() {
    return new _ObservableSanityClient(__privateGet(this, _httpRequest13), this.config());
  }
  config(newConfig) {
    if (newConfig === void 0)
  ...
  withConfig(newConfig) {
    ...
    return new _ObservableSanityClient(__privateGet(this, _httpRequest13), {
      ...thisConfig,
      ...newConfig,
      stega: {
        ...thisConfig.stega || {},
  ...
  getDocument(id, options) {
    return _getDocument(this, __privateGet(this, _httpRequest13), id, options);
  }
  /**
  ...
  getDocuments(ids, options) {
    return _getDocuments(this, __privateGet(this, _httpRequest13), ids, options);
  }
  create(document2, options) {
    return _create(this, __privateGet(this, _httpRequest13), document2, "create", options);
  }
  createIfNotExists(document2, options) {
    return _createIfNotExists(this, __privateGet(this, _httpRequest13), document2, options);
  }
  createOrReplace(document2, options) {
    return _createOrReplace(this, __privateGet(this, _httpRequest13), document2, options);
  }
  createVersion({
    document: document2,
    publishedId,
  ...
  delete(selection, options) {
    return _delete(this, __privateGet(this, _httpRequest13), selection, options);
  }
  /**
   * @public
   *
  ...
  discardVersion({ releaseId, publishedId }, purge, options) {
    ...
    return _discardVersion(this, __privateGet(this, _httpRequest13), documentVersionId, purge, options);
  }
  replaceVersion({
    document: document2,
    publishedId,
    ...
    return _replaceVersion(this, __privateGet(this, _httpRequest13), documentVersion, options);
  }
  /**
   * @public
   *
  ...
  unpublishVersion({ releaseId, publishedId }, options) {
    ...
    return _unpublishVersion(this, __privateGet(this, _httpRequest13), versionId, publishedId, options);
  }
  mutate(operations, options) {
    return _mutate(this, __privateGet(this, _httpRequest13), operations, options);
  }
  /**
  ...
  action(operations, options) {
    return _action(this, __privateGet(this, _httpRequest13), operations, options);
  }
  /**
   ...
   */
  request(options) {
    return _request(this, __privateGet(this, _httpRequest13), options);
  }
  /**
...
var _clientConfig2, _httpRequest14;
var _SanityClient = class _SanityClient {
  constructor(httpRequest, config2 = defaultConfig) {
    ...
    __privateAdd(this, _httpRequest14, void 0);
    /**
     * Instance properties
     */
    __publicField(this, "listen", _listen);
    this.config(config2), __privateSet(this, _httpRequest14, httpRequest), this.assets = new AssetsClient(this, __privateGet(this, _httpRequest14)), this.datasets = new DatasetsClient(this, __privateGet(this, _httpRequest14)), this.live = new LiveClient(this), this.projects = new ProjectsClient(this, __privateGet(this, _httpRequest14)), this.users = new UsersClient(this, __privateGet(this, _httpRequest14)), this.agent = {
      action: new AgentActionsClient(this, __privateGet(this, _httpRequest14))
    }, this.releases = new ReleasesClient(this, __privateGet(this, _httpRequest14)), this.observable = new ObservableSanityClient(httpRequest, config2);
  }
  /**
   * Clone the client - returns a new instance
   */
  clone() {
    return new _SanityClient(__privateGet(this, _httpRequest14), this.config());
  }
  config(newConfig) {
    if (newConfig === void 0)
  ...
  withConfig(newConfig) {
    const thisConfig = this.config();
    return new _SanityClient(__privateGet(this, _httpRequest14), {
      ...thisConfig,
      ...newConfig,
      stega: {
        ...thisConfig.stega || {},
  ...
  fetch(query, params, options) {
    return lastValueFrom(
      _fetch(
        this,
        __privateGet(this, _httpRequest14),
   ...
   */
  getDocument(id, options) {
    return lastValueFrom(_getDocument(this, __privateGet(this, _httpRequest14), id, options));
  }
  /**
   * Fetch multiple documents in one request.
   * Should be used sparingly - performing a query is usually a better option.
   ...
   */
  getDocuments(ids, options) {
    return lastValueFrom(_getDocuments(this, __privateGet(this, _httpRequest14), ids, options));
  }
  create(document2, options) {
    return lastValueFrom(
      _create(this, __privateGet(this, _httpRequest14), document2, "create", options)
    );
  }
  createIfNotExists(document2, options) {
    return lastValueFrom(
      _createIfNotExists(this, __privateGet(this, _httpRequest14), document2, options)
    );
  }
  createOrReplace(document2, options) {
    return lastValueFrom(
      _createOrReplace(this, __privateGet(this, _httpRequest14), document2, options)
    );
  }
  createVersion({
    document: document2,
  ...
  delete(selection, options) {
    return lastValueFrom(_delete(this, __privateGet(this, _httpRequest14), selection, options));
  }
  /**
   * @public
   *
  ...
  discardVersion({ releaseId, publishedId }, purge, options) {
    const documentVersionId = getDocumentVersionId(publishedId, releaseId);
    return lastValueFrom(
      _discardVersion(this, __privateGet(this, _httpRequest14), documentVersionId, purge, options)
    );
  }
  replaceVersion({
    document: document2,
    ...
    return firstValueFrom(
      _replaceVersion(this, __privateGet(this, _httpRequest14), documentVersion, options)
    );
  }
  /**
   * @public
  ...
  unpublishVersion({ releaseId, publishedId }, options) {
    const versionId = getVersionId(publishedId, releaseId);
    return lastValueFrom(
      _unpublishVersion(this, __privateGet(this, _httpRequest14), versionId, publishedId, options)
    );
  }
  mutate(operations, options) {
    return lastValueFrom(_mutate(this, __privateGet(this, _httpRequest14), operations, options));
  }
  /**
   * Create a new buildable patch of operations to perform
   *
   ...
   */
  action(operations, options) {
    return lastValueFrom(_action(this, __privateGet(this, _httpRequest14), operations, options));
  }
  /**
   ...
   */
  request(options) {
    return lastValueFrom(_request(this, __privateGet(this, _httpRequest14), options));
  }
  /**
  ...
  dataRequest(endpoint, body, options) {
    return lastValueFrom(_dataRequest(this, __privateGet(this, _httpRequest14), endpoint, body, options));
  }
  /**
   * Get a Sanity API URL for the URI provided
   *
